import { DefaultCdkOptions, RequireApproval } from '@aws-cdk/cloud-assembly-schema/lib/integ-tests/commands/common/cloud-assembly-schema/lib/integ-tests/commands/common';
/**
