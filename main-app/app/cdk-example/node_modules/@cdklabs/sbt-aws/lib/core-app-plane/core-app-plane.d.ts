...
import { ScriptJob } from '@cdklabs/sbt-aws/lib/core-app-plane/script-job-aws/lib/core-app-plane/script-job';
 ...
 */
export declare class CoreApplicationPlane extends Construct {
    /**
