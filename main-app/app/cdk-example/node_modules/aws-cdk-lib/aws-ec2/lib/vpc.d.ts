...
import { ClientVpnEndpoint, ClientVpnEndpointOptions } from 'aws-cdk-lib/aws-ec2/lib/client-vpn-endpointib/client-vpn-endpoint';
import { CfnNatGateway } from 'aws-cdk-lib/aws-ec2/lib/ec2.generated-ec2/lib/ec2.generated';
import { IIpAddresses, IIpv6Addresses } from 'aws-cdk-lib/aws-ec2/lib/ip-addressess-ec2/lib/ip-addresses';
import { NatProvider } from 'aws-cdk-lib/aws-ec2/lib/natdk-lib/aws-ec2/lib/nat';
import { INetworkAcl } from 'aws-cdk-lib/aws-ec2/lib/network-aclws-ec2/lib/network-acl';
import { SubnetFilter } from 'aws-cdk-lib/aws-ec2/lib/subnetlib/aws-ec2/lib/subnet';
import { GatewayVpcEndpoint, GatewayVpcEndpointOptions, InterfaceVpcEndpoint, InterfaceVpcEndpointOptions } from 'aws-cdk-lib/aws-ec2/lib/vpc-endpoints-ec2/lib/vpc-endpoint';
import { FlowLog, FlowLogOptions } from 'aws-cdk-lib/aws-ec2/lib/vpc-flow-logs-ec2/lib/vpc-flow-logs';
import { VpcLookupOptions } from 'aws-cdk-lib/aws-ec2/lib/vpc-lookupaws-ec2/lib/vpc-lookup';
import { EnableVpnGatewayOptions, VpnConnection, VpnConnectionOptions } from 'aws-cdk-lib/aws-ec2/lib/vpndk-lib/aws-ec2/lib/vpn';
import { IResource, Resource } from 'aws-cdk-lib/coreb/core';
