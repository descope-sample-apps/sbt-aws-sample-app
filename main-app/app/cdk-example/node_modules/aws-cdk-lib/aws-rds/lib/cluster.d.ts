...
import { IClusterInstance } from 'aws-cdk-lib/aws-rds/lib/aurora-cluster-instanceurora-cluster-instance';
import { IClusterEngine } from 'aws-cdk-lib/aws-rds/lib/cluster-enginerds/lib/cluster-engine';
import { DatabaseClusterAttributes, IDatabaseCluster } from 'aws-cdk-lib/aws-rds/lib/cluster-refws-rds/lib/cluster-ref';
import { Endpoint } from 'aws-cdk-lib/aws-rds/lib/endpointb/aws-rds/lib/endpoint';
import { NetworkType } from 'aws-cdk-lib/aws-rds/lib/instanceb/aws-rds/lib/instance';
import { IParameterGroup } from 'aws-cdk-lib/aws-rds/lib/parameter-groupds/lib/parameter-group';
import { BackupProps, Credentials, InstanceProps, PerformanceInsightRetention, RotationSingleUserOptions, RotationMultiUserOptions, SnapshotCredentials } from 'aws-cdk-lib/aws-rds/lib/props-lib/aws-rds/lib/props';
import { DatabaseProxy, DatabaseProxyOptions } from 'aws-cdk-lib/aws-rds/lib/proxy-lib/aws-rds/lib/proxy';
import { CfnDBClusterProps } from 'aws-cdk-lib/aws-rds/lib/rds.generated-rds/lib/rds.generated';
import { ISubnetGroup } from 'aws-cdk-lib/aws-rds/lib/subnet-groups-rds/lib/subnet-group';
...
import { IRole } from 'aws-cdk-lib/aws-iamws-iam';
import * as kms from 'aws-cdk-lib/aws-kmsws-kms';
import * as logs from 'aws-cdk-lib/aws-logss-logs';
import * as s3 from 'aws-cdk-lib/aws-s3aws-s3';
import * as secretsmanager from 'aws-cdk-lib/aws-secretsmanageranager';
import { Duration, RemovalPolicy, Resource } from 'aws-cdk-lib/coreb/core';
/**
