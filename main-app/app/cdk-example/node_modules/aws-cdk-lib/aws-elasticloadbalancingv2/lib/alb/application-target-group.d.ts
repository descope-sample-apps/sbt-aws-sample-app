...
import { IApplicationListener } from 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/alb/application-listenercloadbalancingv2/lib/alb/application-listener';
import { HttpCodeTarget } from 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/alb/application-load-balancerbalancingv2/lib/alb/application-load-balancer';
...
import { BaseTargetGroupProps, ITargetGroup, LoadBalancerTargetProps, TargetGroupAttributes, TargetGroupBase } from 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/shared/base-target-groupbalancingv2/lib/shared/base-target-group';
import { ApplicationProtocol, ApplicationProtocolVersion, TargetGroupLoadBalancingAlgorithmType } from 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/shared/enums-elasticloadbalancingv2/lib/shared/enums';
/**
