...
import { Grant } from 'aws-cdk-lib/aws-iam/lib/grant-lib/aws-iam/lib/grant';
import { IIdentity } from 'aws-cdk-lib/aws-iam/lib/identity-base-iam/lib/identity-base';
import { IManagedPolicy } from 'aws-cdk-lib/aws-iam/lib/managed-policyiam/lib/managed-policy';
import { Policy } from 'aws-cdk-lib/aws-iam/lib/policylib/aws-iam/lib/policy';
import { PolicyDocument } from 'aws-cdk-lib/aws-iam/lib/policy-documentam/lib/policy-document';
import { PolicyStatement } from 'aws-cdk-lib/aws-iam/lib/policy-statementm/lib/policy-statement';
import { AddToPrincipalPolicyResult, IPrincipal, PrincipalPolicyFragment } from 'aws-cdk-lib/aws-iam/lib/principalsaws-iam/lib/principals';
import { Duration, Resource, RemovalPolicy } from 'aws-cdk-lib/coreb/core';
/**
