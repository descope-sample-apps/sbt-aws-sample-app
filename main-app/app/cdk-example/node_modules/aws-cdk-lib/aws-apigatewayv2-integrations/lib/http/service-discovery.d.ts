import { HttpPrivateIntegrationOptions } from 'aws-cdk-lib/aws-apigatewayv2-integrations/lib/http/base-typesaws-apigatewayv2-integrations/lib/http/base-types';
import { HttpPrivateIntegration } from 'aws-cdk-lib/aws-apigatewayv2-integrations/lib/http/private/integrationtewayv2-integrations/lib/http/private/integration';
import { HttpRouteIntegrationBindOptions, HttpRouteIntegrationConfig } from 'aws-cdk-lib/aws-apigatewayv2yv2';
import * as servicediscovery from 'aws-cdk-lib/aws-servicediscoveryery';
/**
