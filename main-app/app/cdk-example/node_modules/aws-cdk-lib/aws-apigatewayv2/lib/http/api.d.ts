...
import { IHttpRouteAuthorizer } from 'aws-cdk-lib/aws-apigatewayv2/lib/http/authorizeraws-apigatewayv2/lib/http/authorizer';
import { HttpRouteIntegration } from 'aws-cdk-lib/aws-apigatewayv2/lib/http/integrationws-apigatewayv2/lib/http/integration';
import { BatchHttpRouteOptions, HttpMethod, HttpRoute } from 'aws-cdk-lib/aws-apigatewayv2/lib/http/route-lib/aws-apigatewayv2/lib/http/route';
import { IHttpStage, HttpStage, HttpStageOptions } from 'aws-cdk-lib/aws-apigatewayv2/lib/http/stage-lib/aws-apigatewayv2/lib/http/stage';
import { VpcLink, VpcLinkProps } from 'aws-cdk-lib/aws-apigatewayv2/lib/http/vpc-linkb/aws-apigatewayv2/lib/http/vpc-link';
import { Metric, MetricOptions } from 'aws-cdk-lib/aws-cloudwatchtch';
import { Duration } from 'aws-cdk-lib/coreore';
import { IApi } from 'aws-cdk-lib/aws-apigatewayv2/lib/common/apiws-apigatewayv2/lib/common/api';
import { ApiBase } from 'aws-cdk-lib/aws-apigatewayv2/lib/common/bases-apigatewayv2/lib/common/base';
import { DomainMappingOptions } from 'aws-cdk-lib/aws-apigatewayv2/lib/common/stage-apigatewayv2/lib/common/stage';
/**
