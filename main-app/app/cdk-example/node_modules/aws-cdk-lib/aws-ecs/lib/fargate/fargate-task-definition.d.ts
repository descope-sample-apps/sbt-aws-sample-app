...
import { CommonTaskDefinitionAttributes, CommonTaskDefinitionProps, ITaskDefinition, NetworkMode, PidMode, TaskDefinition } from 'aws-cdk-lib/aws-ecs/lib/base/task-definition/base/task-definition';
