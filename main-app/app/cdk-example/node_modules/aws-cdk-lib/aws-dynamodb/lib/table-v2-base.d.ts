import { SystemErrorsForOperationsMetricOptions, OperationsMetricOptions, ITable } from 'aws-cdk-lib/aws-dynamodb/lib/sharedlib/aws-dynamodb/lib/shared';
import { IMetric, Metric, MetricOptions } from 'aws-cdk-lib/aws-cloudwatchdwatch';
import { AddToResourcePolicyResult, Grant, IGrantable, IResourceWithPolicy, PolicyDocument, PolicyStatement } from 'aws-cdk-lib/aws-iamws-iam';
