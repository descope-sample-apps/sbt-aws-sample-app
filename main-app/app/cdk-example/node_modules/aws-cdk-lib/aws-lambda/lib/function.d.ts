...
import { AdotInstrumentationConfig } from 'aws-cdk-lib/aws-lambda/lib/adot-layersws-lambda/lib/adot-layers';
import { AliasOptions, Alias } from 'aws-cdk-lib/aws-lambda/lib/alias-lib/aws-lambda/lib/alias';
import { Architecture } from 'aws-cdk-lib/aws-lambda/lib/architectures-lambda/lib/architecture';
import { Code, CodeConfig } from 'aws-cdk-lib/aws-lambda/lib/codek-lib/aws-lambda/lib/code';
import { ICodeSigningConfig } from 'aws-cdk-lib/aws-lambda/lib/code-signing-configa/lib/code-signing-config';
import { EventInvokeConfigOptions } from 'aws-cdk-lib/aws-lambda/lib/event-invoke-configa/lib/event-invoke-config';
import { IEventSource } from 'aws-cdk-lib/aws-lambda/lib/event-sources-lambda/lib/event-source';
import { FileSystem } from 'aws-cdk-lib/aws-lambda/lib/filesystemaws-lambda/lib/filesystem';
import { FunctionAttributes, FunctionBase, IFunction } from 'aws-cdk-lib/aws-lambda/lib/function-base-lambda/lib/function-base';
import { LambdaInsightsVersion } from 'aws-cdk-lib/aws-lambda/lib/lambda-insightsambda/lib/lambda-insights';
import { Version, VersionOptions } from 'aws-cdk-lib/aws-lambda/lib/lambda-versionlambda/lib/lambda-version';
import { ILayerVersion } from 'aws-cdk-lib/aws-lambda/lib/layerslib/aws-lambda/lib/layers';
import { LogRetentionRetryOptions } from 'aws-cdk-lib/aws-lambda/lib/log-retention-lambda/lib/log-retention';
import { ParamsAndSecretsLayerVersion } from 'aws-cdk-lib/aws-lambda/lib/params-and-secrets-layersparams-and-secrets-layers';
import { Runtime } from 'aws-cdk-lib/aws-lambda/lib/runtimeib/aws-lambda/lib/runtime';
import { RuntimeManagementMode } from 'aws-cdk-lib/aws-lambda/lib/runtime-managementda/lib/runtime-management';
import { SnapStartConf } from 'aws-cdk-lib/aws-lambda/lib/snapstart-configmbda/lib/snapstart-config';
import * as cloudwatch from 'aws-cdk-lib/aws-cloudwatchdwatch';
import { IProfilingGroup } from 'aws-cdk-lib/aws-codeguruprofilerofiler';
import * as ec2 from 'aws-cdk-lib/aws-ec2ws-ec2';
import * as iam from 'aws-cdk-lib/aws-iamws-iam';
import * as kms from 'aws-cdk-lib/aws-kmsws-kms';
import * as logs from 'aws-cdk-lib/aws-logss-logs';
import * as sns from 'aws-cdk-lib/aws-snsws-sns';
import * as sqs from 'aws-cdk-lib/aws-sqsws-sqs';
import { Duration, IAspect, Size } from 'aws-cdk-lib/coreb/core';
/**
