...
import { AddStageOpts as StageOptions, WaveOptions, Wave, IFileSetProducer, FileSet } from 'aws-cdk-lib/pipelines/lib/blueprintpipelines/lib/blueprint';
/**
...
export declare abstract class PipelineBase extends Construct {
     ...
     */
    addStage(stage: Stage, options?: StageOptions): import("aws-cdk-lib/pipelines/lib/blueprintpipelines/lib/blueprint").StageDeployment;
    /**
