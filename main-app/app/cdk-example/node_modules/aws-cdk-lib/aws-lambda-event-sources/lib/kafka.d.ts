import { StreamEventSource, BaseStreamEventSourceProps } from 'aws-cdk-lib/aws-lambda-event-sources/lib/streamlib/aws-lambda-event-sources/lib/stream';
import { ISecurityGroup, IVpc, SubnetSelection } from 'aws-cdk-lib/aws-ec2ws-ec2';
