...
import { DailyAutomaticBackupStartTime } from 'aws-cdk-lib/aws-fsx/lib/daily-automatic-backup-start-timeatic-backup-start-time';
import { FileSystemAttributes, FileSystemBase, FileSystemProps, IFileSystem } from 'aws-cdk-lib/aws-fsx/lib/file-systemws-fsx/lib/file-system';
import { LustreMaintenanceTime } from 'aws-cdk-lib/aws-fsx/lib/maintenance-timex/lib/maintenance-time';
import { Connections, ISubnet } from 'aws-cdk-lib/aws-ec2ws-ec2';
import { Duration } from 'aws-cdk-lib/coreb/core';
/**
