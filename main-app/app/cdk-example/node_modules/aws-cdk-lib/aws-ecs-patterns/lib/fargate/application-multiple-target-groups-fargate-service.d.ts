...
import { FargateService, FargateTaskDefinition } from 'aws-cdk-lib/aws-ecsecs';
import { ApplicationTargetGroup } from 'aws-cdk-lib/aws-elasticloadbalancingv2gv2';
import { ApplicationMultipleTargetGroupsServiceBase, ApplicationMultipleTargetGroupsServiceBaseProps } from 'aws-cdk-lib/aws-ecs-patterns/lib/base/application-multiple-target-groups-service-baseple-target-groups-service-base';
import { FargateServiceBaseProps } from 'aws-cdk-lib/aws-ecs-patterns/lib/base/fargate-service-base/lib/base/fargate-service-base';
/**
