...
import { TenantRegistrationTable } from '@cdklabs/sbt-aws/lib/control-plane/tenant-registration/tenant-registration.tablel-plane/tenant-registration/tenant-registration.table';
import { IEventManager } from '@cdklabs/sbt-aws/lib/utilst-aws/lib/utils';
import { IAuth } from '@cdklabs/sbt-aws/lib/control-plane/auth/auth-interfaceontrol-plane/auth/auth-interface';
import { TenantManagementService } from '@cdklabs/sbt-aws/lib/control-plane/tenant-management/control-plane/tenant-management';
/**
