...
import { Schedule } from 'aws-cdk-lib/aws-applicationautoscalinging';
import { ISecurityGroup, IVpc, SubnetSelection } from 'aws-cdk-lib/aws-ec2ec2';
import { AwsLogDriver, Cluster, ContainerImage, ICluster, LogDriver, PropagatedTagSource, Secret, TaskDefinition } from 'aws-cdk-lib/aws-ecsecs';
import { Rule } from 'aws-cdk-lib/aws-eventsnts';
import { EcsTask, Tag } from 'aws-cdk-lib/aws-events-targetsets';
/**
