...
import { IHttpApi } from 'aws-cdk-lib/aws-apigatewayv2/lib/http/apidk-lib/aws-apigatewayv2/lib/http/api';
import { HttpMethod, IHttpRoute } from 'aws-cdk-lib/aws-apigatewayv2/lib/http/route-lib/aws-apigatewayv2/lib/http/route';
import { IRole } from 'aws-cdk-lib/aws-iamiam';
import { Duration, Resource } from 'aws-cdk-lib/coreore';
import { IIntegration } from 'aws-cdk-lib/aws-apigatewayv2/lib/commonib/aws-apigatewayv2/lib/common';
import { ParameterMapping } from 'aws-cdk-lib/aws-apigatewayv2/lib/parameter-mappingatewayv2/lib/parameter-mapping';
/**
