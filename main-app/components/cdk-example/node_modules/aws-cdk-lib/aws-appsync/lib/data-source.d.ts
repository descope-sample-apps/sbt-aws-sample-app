...
import { BaseAppsyncFunctionProps, AppsyncFunction } from 'aws-cdk-lib/aws-appsync/lib/appsync-functionpsync/lib/appsync-function';
import { CfnDataSource } from 'aws-cdk-lib/aws-appsync/lib/appsync.generatedsync/lib/appsync.generated';
import { IGraphqlApi } from 'aws-cdk-lib/aws-appsync/lib/graphqlapi-baseppsync/lib/graphqlapi-base';
import { BaseResolverProps, Resolver } from 'aws-cdk-lib/aws-appsync/lib/resolverb/aws-appsync/lib/resolver';
import { ITable } from 'aws-cdk-lib/aws-dynamodbnamodb';
import { IDomain as IElasticsearchDomain } from 'aws-cdk-lib/aws-elasticsearchsearch';
import { IEventBus } from 'aws-cdk-lib/aws-eventsevents';
import { IGrantable, IPrincipal, IRole } from 'aws-cdk-lib/aws-iamws-iam';
import { IFunction } from 'aws-cdk-lib/aws-lambdalambda';
import { IDomain as IOpenSearchDomain } from 'aws-cdk-lib/aws-opensearchserviceervice';
import { IServerlessCluster, IDatabaseCluster } from 'aws-cdk-lib/aws-rdsws-rds';
import { ISecret } from 'aws-cdk-lib/aws-secretsmanageranager';
import { IResolvable } from 'aws-cdk-lib/coreb/core';
/**
