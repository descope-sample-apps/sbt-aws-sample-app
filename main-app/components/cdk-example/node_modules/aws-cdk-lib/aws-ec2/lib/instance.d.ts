...
import { CloudFormationInit } from 'aws-cdk-lib/aws-ec2/lib/cfn-initb/aws-ec2/lib/cfn-init';
import { Connections, IConnectable } from 'aws-cdk-lib/aws-ec2/lib/connectionsws-ec2/lib/connections';
import { CfnInstance } from 'aws-cdk-lib/aws-ec2/lib/ec2.generated-ec2/lib/ec2.generated';
import { InstanceType } from 'aws-cdk-lib/aws-ec2/lib/instance-typesec2/lib/instance-types';
import { IKeyPair } from 'aws-cdk-lib/aws-ec2/lib/key-pairb/aws-ec2/lib/key-pair';
import { CpuCredits, InstanceInitiatedShutdownBehavior } from 'aws-cdk-lib/aws-ec2/lib/launch-templatec2/lib/launch-template';
import { IMachineImage, OperatingSystemType } from 'aws-cdk-lib/aws-ec2/lib/machine-image-ec2/lib/machine-image';
import { IPlacementGroup } from 'aws-cdk-lib/aws-ec2/lib/placement-groupc2/lib/placement-group';
import { ISecurityGroup } from 'aws-cdk-lib/aws-ec2/lib/security-groupec2/lib/security-group';
import { UserData } from 'aws-cdk-lib/aws-ec2/lib/user-data/aws-ec2/lib/user-data';
import { BlockDevice } from 'aws-cdk-lib/aws-ec2/lib/volumelib/aws-ec2/lib/volume';
import { IVpc, SubnetSelection } from 'aws-cdk-lib/aws-ec2/lib/vpcdk-lib/aws-ec2/lib/vpc';
