...
import { Schedule } from 'aws-cdk-lib/aws-applicationautoscaling/lib/scheduleb/aws-applicationautoscaling/lib/schedule';
import { BasicStepScalingPolicyProps, StepScalingPolicy } from 'aws-cdk-lib/aws-applicationautoscaling/lib/step-scaling-policycationautoscaling/lib/step-scaling-policy';
import { BasicTargetTrackingScalingPolicyProps, TargetTrackingScalingPolicy } from 'aws-cdk-lib/aws-applicationautoscaling/lib/target-tracking-scaling-policycaling/lib/target-tracking-scaling-policy';
import * as iam from 'aws-cdk-lib/aws-iamws-iam';
import { IResource, Resource, TimeZone } from 'aws-cdk-lib/coreb/core';
