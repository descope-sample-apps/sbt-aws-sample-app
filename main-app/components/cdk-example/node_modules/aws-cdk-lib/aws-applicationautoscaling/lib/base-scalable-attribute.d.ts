...
import { ScalingSchedule, ServiceNamespace } from 'aws-cdk-lib/aws-applicationautoscaling/lib/scalable-targetpplicationautoscaling/lib/scalable-target';
import { BasicStepScalingPolicyProps } from 'aws-cdk-lib/aws-applicationautoscaling/lib/step-scaling-policycationautoscaling/lib/step-scaling-policy';
import { BasicTargetTrackingScalingPolicyProps } from 'aws-cdk-lib/aws-applicationautoscaling/lib/target-tracking-scaling-policycaling/lib/target-tracking-scaling-policy';
