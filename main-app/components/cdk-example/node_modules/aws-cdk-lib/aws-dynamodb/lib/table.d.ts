...
import { CfnTable } from 'aws-cdk-lib/aws-dynamodb/lib/dynamodb.generatedmodb/lib/dynamodb.generated';
import { EnableScalingProps, IScalableTableAttribute } from 'aws-cdk-lib/aws-dynamodb/lib/scalable-attribute-api/lib/scalable-attribute-api';
import { OperationsMetricOptions, SystemErrorsForOperationsMetricOptions, Attribute, BillingMode, ITable, SecondaryIndexProps, TableClass, LocalSecondaryIndexProps, TableEncryption, StreamViewType } from 'aws-cdk-lib/aws-dynamodb/lib/sharedlib/aws-dynamodb/lib/shared';
import * as cloudwatch from 'aws-cdk-lib/aws-cloudwatchdwatch';
import * as iam from 'aws-cdk-lib/aws-iamws-iam';
import * as kinesis from 'aws-cdk-lib/aws-kinesisinesis';
import * as kms from 'aws-cdk-lib/aws-kmsws-kms';
import * as s3 from 'aws-cdk-lib/aws-s3aws-s3';
import { Resource, Duration, RemovalPolicy } from 'aws-cdk-lib/coreb/core';
/**
