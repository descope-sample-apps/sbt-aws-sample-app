...
import { Billing } from 'aws-cdk-lib/aws-dynamodb/lib/billingib/aws-dynamodb/lib/billing';
import { Capacity } from 'aws-cdk-lib/aws-dynamodb/lib/capacityb/aws-dynamodb/lib/capacity';
import { TableEncryptionV2 } from 'aws-cdk-lib/aws-dynamodb/lib/encryptionaws-dynamodb/lib/encryption';
import { StreamViewType, Attribute, TableClass, LocalSecondaryIndexProps, SecondaryIndexProps } from 'aws-cdk-lib/aws-dynamodb/lib/sharedlib/aws-dynamodb/lib/shared';
import { TableBaseV2, ITableV2 } from 'aws-cdk-lib/aws-dynamodb/lib/table-v2-base-dynamodb/lib/table-v2-base';
import { PolicyDocument } from 'aws-cdk-lib/aws-iamws-iam';
import { IStream } from 'aws-cdk-lib/aws-kinesisinesis';
import { IKey } from 'aws-cdk-lib/aws-kmsws-kms';
import { CfnTag, RemovalPolicy } from 'aws-cdk-lib/coreb/core';
/**
