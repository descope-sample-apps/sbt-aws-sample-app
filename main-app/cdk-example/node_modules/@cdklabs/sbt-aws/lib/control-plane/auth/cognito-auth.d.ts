...
import { CreateAdminUserProps, IAuth } from '@cdklabs/sbt-aws/lib/control-plane/auth/auth-interface/lib/control-plane/auth/auth-interface/lib/control-plane/auth/auth-interface/lib/control-plane/auth/auth-interface';
/**
 ...
 */
export declare class CognitoAuth extends Construct implements IAuth {
    /**
     ...
     */
    private readonly createAdminUserFunction;
