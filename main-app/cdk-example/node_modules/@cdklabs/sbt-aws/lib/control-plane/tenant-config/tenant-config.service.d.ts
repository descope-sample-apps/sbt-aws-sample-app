...
import { TenantManagementTable } from '@cdklabs/sbt-aws/lib/control-plane/tenant-management/tenant-management.tablenagement/tenant-management.tablenagement/tenant-management.tablenagement/tenant-management.table';
/**
...
*/
export declare class TenantConfigService extends Construct {
