...
import { IJenkinsProvider } from 'aws-cdk-lib/aws-codepipeline-actions/lib/jenkins/jenkins-providerdepipeline-actions/lib/jenkins/jenkins-providerdepipeline-actions/lib/jenkins/jenkins-provider';
