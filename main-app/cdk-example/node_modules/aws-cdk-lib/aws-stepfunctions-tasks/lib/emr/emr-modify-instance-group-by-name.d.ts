...
import { EmrCreateCluster } from 'aws-cdk-lib/aws-stepfunctions-tasks/lib/emr/emr-create-clusterfunctions-tasks/lib/emr/emr-create-clusterfunctions-tasks/lib/emr/emr-create-cluster';
