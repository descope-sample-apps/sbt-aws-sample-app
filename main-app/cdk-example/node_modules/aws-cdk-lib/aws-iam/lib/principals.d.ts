import { IDependable } from 'constructs/lib';
import { IOpenIdConnectProvider } from 'aws-cdk-lib/aws-iam/lib/oidc-provider-iam/lib/oidc-provider-iam/lib/oidc-provider';
import { PolicyDocument } from 'aws-cdk-lib/aws-iam/lib/policy-documentam/lib/policy-documentam/lib/policy-document';
import { Condition, Conditions, PolicyStatement } from 'aws-cdk-lib/aws-iam/lib/policy-statementm/lib/policy-statementm/lib/policy-statement';
import { ISamlProvider } from 'aws-cdk-lib/aws-iam/lib/saml-provider-iam/lib/saml-provider-iam/lib/saml-provider';
/**
