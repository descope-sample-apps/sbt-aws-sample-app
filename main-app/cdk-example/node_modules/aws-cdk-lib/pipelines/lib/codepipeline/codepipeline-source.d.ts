import { CodePipelineActionFactoryResult, ProduceActionOptions, ICodePipelineActionFactory } from 'aws-cdk-lib/pipelines/lib/codepipeline/codepipeline-action-factoryepipeline/codepipeline-action-factoryepipeline/codepipeline-action-factory';
import * as codecommit from 'aws-cdk-lib/aws-codecommitmitmitmit';
import * as cp from 'aws-cdk-lib/aws-codepipelineineineine';
import { Artifact } from 'aws-cdk-lib/aws-codepipelineineineine';
import { Action, CodeCommitTrigger, GitHubTrigger, S3Trigger } from 'aws-cdk-lib/aws-codepipeline-actionsonsonsons';
import { IRepository } from 'aws-cdk-lib/aws-ecrecrecrecr';
import * as iam from 'aws-cdk-lib/aws-iamiamiamiam';
import { IBucket } from 'aws-cdk-lib/aws-s3-s3-s3-s3';
import { SecretValue } from 'aws-cdk-lib/coreoreoreore';
import { Step } from 'aws-cdk-lib/pipelines/lib/blueprintpipelines/lib/blueprintpipelines/lib/blueprint';
/**
