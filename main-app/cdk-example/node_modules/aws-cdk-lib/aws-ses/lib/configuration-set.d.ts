...
import { ConfigurationSetEventDestination, ConfigurationSetEventDestinationOptions } from 'aws-cdk-lib/aws-ses/lib/configuration-set-event-destination-set-event-destination-set-event-destination';
import { IDedicatedIpPool } from 'aws-cdk-lib/aws-ses/lib/dedicated-ip-pool/lib/dedicated-ip-pool/lib/dedicated-ip-pool';
