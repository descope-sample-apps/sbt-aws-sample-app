...
import { ApplicationListener, BaseApplicationListenerProps } from 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/alb/application-listenercloadbalancingv2/lib/alb/application-listenercloadbalancingv2/lib/alb/application-listener';
import * as cloudwatch from 'aws-cdk-lib/aws-cloudwatchtchtchtch';
import * as ec2 from 'aws-cdk-lib/aws-ec2ec2ec2ec2';
import * as s3 from 'aws-cdk-lib/aws-s3-s3-s3-s3';
import { Duration } from 'aws-cdk-lib/coreoreoreore';
import { BaseLoadBalancer, BaseLoadBalancerLookupOptions, BaseLoadBalancerProps, ILoadBalancerV2 } from 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/shared/base-load-balanceralancingv2/lib/shared/base-load-balanceralancingv2/lib/shared/base-load-balancer';
import { IpAddressType, ApplicationProtocol, DesyncMitigationMode } from 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/shared/enums-elasticloadbalancingv2/lib/shared/enums-elasticloadbalancingv2/lib/shared/enums';
/**
