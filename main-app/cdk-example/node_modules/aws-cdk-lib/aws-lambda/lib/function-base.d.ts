import { Construct, Node } from 'constructs/lib';
...
import { EventSourceMapping, EventSourceMappingOptions } from 'aws-cdk-lib/aws-lambda/lib/event-source-mapping/lib/event-source-mapping/lib/event-source-mapping';
import { FunctionUrlOptions, FunctionUrl } from 'aws-cdk-lib/aws-lambda/lib/function-urls-lambda/lib/function-urls-lambda/lib/function-url';
import { IVersion } from 'aws-cdk-lib/aws-lambda/lib/lambda-versionlambda/lib/lambda-versionlambda/lib/lambda-version';
import { Permission } from 'aws-cdk-lib/aws-lambda/lib/permissionaws-lambda/lib/permissionaws-lambda/lib/permission';
