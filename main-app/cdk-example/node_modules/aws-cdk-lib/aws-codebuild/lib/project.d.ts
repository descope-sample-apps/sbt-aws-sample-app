...
import { IArtifacts } from 'aws-cdk-lib/aws-codebuild/lib/artifacts/aws-codebuild/lib/artifacts/aws-codebuild/lib/artifacts';
import { BuildSpec } from 'aws-cdk-lib/aws-codebuild/lib/build-specaws-codebuild/lib/build-specaws-codebuild/lib/build-spec';
import { Cache } from 'aws-cdk-lib/aws-codebuild/lib/cache-lib/aws-codebuild/lib/cache-lib/aws-codebuild/lib/cache';
import { CfnProject } from 'aws-cdk-lib/aws-codebuild/lib/codebuild.generateduild/lib/codebuild.generateduild/lib/codebuild.generated';
import { ComputeType } from 'aws-cdk-lib/aws-codebuild/lib/compute-types-codebuild/lib/compute-types-codebuild/lib/compute-type';
import { IFileSystemLocation } from 'aws-cdk-lib/aws-codebuild/lib/file-location-codebuild/lib/file-location-codebuild/lib/file-location';
import { IFleet } from 'aws-cdk-lib/aws-codebuild/lib/fleet-lib/aws-codebuild/lib/fleet-lib/aws-codebuild/lib/fleet';
import { LoggingOptions } from 'aws-cdk-lib/aws-codebuild/lib/project-logss-codebuild/lib/project-logss-codebuild/lib/project-logs';
import { ISource } from 'aws-cdk-lib/aws-codebuild/lib/sourcelib/aws-codebuild/lib/sourcelib/aws-codebuild/lib/source';
import * as cloudwatch from 'aws-cdk-lib/aws-cloudwatchdwatchdwatchdwatch';
import * as notifications from 'aws-cdk-lib/aws-codestarnotificationsationsationsations';
import * as ec2 from 'aws-cdk-lib/aws-ec2ws-ec2ws-ec2ws-ec2';
import * as ecr from 'aws-cdk-lib/aws-ecrws-ecrws-ecrws-ecr';
import { DockerImageAssetProps } from 'aws-cdk-lib/aws-ecr-assetsassetsassetsassets';
import * as events from 'aws-cdk-lib/aws-eventseventseventsevents';
import * as iam from 'aws-cdk-lib/aws-iamws-iamws-iamws-iam';
import * as kms from 'aws-cdk-lib/aws-kmsws-kmsws-kmsws-kms';
import * as s3 from 'aws-cdk-lib/aws-s3aws-s3aws-s3aws-s3';
import * as secretsmanager from 'aws-cdk-lib/aws-secretsmanageranageranageranager';
import { Duration, IResource, Resource } from 'aws-cdk-lib/coreb/coreb/coreb/core';
/**
