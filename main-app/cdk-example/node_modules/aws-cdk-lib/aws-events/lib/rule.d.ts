...
import { IEventBus } from 'aws-cdk-lib/aws-events/lib/event-bus/aws-events/lib/event-bus/aws-events/lib/event-bus';
import { EventPattern } from 'aws-cdk-lib/aws-events/lib/event-pattern-events/lib/event-pattern-events/lib/event-pattern';
import { EventCommonOptions } from 'aws-cdk-lib/aws-events/lib/on-event-optionsents/lib/on-event-optionsents/lib/on-event-options';
import { IRule } from 'aws-cdk-lib/aws-events/lib/rule-refb/aws-events/lib/rule-refb/aws-events/lib/rule-ref';
import { Schedule } from 'aws-cdk-lib/aws-events/lib/scheduleb/aws-events/lib/scheduleb/aws-events/lib/schedule';
import { IRuleTarget } from 'aws-cdk-lib/aws-events/lib/targetlib/aws-events/lib/targetlib/aws-events/lib/target';
