import { Construct, IDependable } from 'constructs/lib';
import { ClientVpnAuthorizationRule, ClientVpnAuthorizationRuleOptions } from 'aws-cdk-lib/aws-ec2/lib/client-vpn-authorization-rulevpn-authorization-rulevpn-authorization-rule';
import { IClientVpnConnectionHandler, IClientVpnEndpoint, TransportProtocol, VpnPort } from 'aws-cdk-lib/aws-ec2/lib/client-vpn-endpoint-typesent-vpn-endpoint-typesent-vpn-endpoint-types';
import { ClientVpnRoute, ClientVpnRouteOptions } from 'aws-cdk-lib/aws-ec2/lib/client-vpn-route2/lib/client-vpn-route2/lib/client-vpn-route';
...
import { ISamlProvider } from 'aws-cdk-lib/aws-iamws-iamws-iamws-iam';
