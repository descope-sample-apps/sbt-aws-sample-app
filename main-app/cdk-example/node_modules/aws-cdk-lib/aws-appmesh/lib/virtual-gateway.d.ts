...
import { GatewayRoute, GatewayRouteBaseProps } from 'aws-cdk-lib/aws-appmesh/lib/gateway-route-appmesh/lib/gateway-route-appmesh/lib/gateway-route';
import { IMesh } from 'aws-cdk-lib/aws-appmesh/lib/meshk-lib/aws-appmesh/lib/meshk-lib/aws-appmesh/lib/mesh';
import { AccessLog, BackendDefaults } from 'aws-cdk-lib/aws-appmesh/lib/shared-interfacesmesh/lib/shared-interfacesmesh/lib/shared-interfaces';
import { VirtualGatewayListener, VirtualGatewayListenerConfig } from 'aws-cdk-lib/aws-appmesh/lib/virtual-gateway-listenerb/virtual-gateway-listenerb/virtual-gateway-listener';
