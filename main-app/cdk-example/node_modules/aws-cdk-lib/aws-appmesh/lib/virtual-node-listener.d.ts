...
import { CfnVirtualNode } from 'aws-cdk-lib/aws-appmesh/lib/appmesh.generatedmesh/lib/appmesh.generatedmesh/lib/appmesh.generated';
import { HealthCheck } from 'aws-cdk-lib/aws-appmesh/lib/health-checks-appmesh/lib/health-checks-appmesh/lib/health-checks';
import { ListenerTlsOptions } from 'aws-cdk-lib/aws-appmesh/lib/listener-tls-optionsh/lib/listener-tls-optionsh/lib/listener-tls-options';
import { GrpcConnectionPool, GrpcTimeout, Http2ConnectionPool, HttpConnectionPool, HttpTimeout, OutlierDetection, TcpConnectionPool, TcpTimeout } from 'aws-cdk-lib/aws-appmesh/lib/shared-interfacesmesh/lib/shared-interfacesmesh/lib/shared-interfaces';
/**
