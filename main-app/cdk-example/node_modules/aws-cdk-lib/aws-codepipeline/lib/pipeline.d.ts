...
import { IAction, IPipeline, IStage, PipelineNotifyOnOptions } from 'aws-cdk-lib/aws-codepipeline/lib/actionlib/aws-codepipeline/lib/actionlib/aws-codepipeline/lib/action';
import { FullActionDescriptor } from 'aws-cdk-lib/aws-codepipeline/lib/private/full-action-descriptor/private/full-action-descriptor/private/full-action-descriptor';
import { Stage } from 'aws-cdk-lib/aws-codepipeline/lib/private/stage-codepipeline/lib/private/stage-codepipeline/lib/private/stage';
import { Trigger, TriggerProps } from 'aws-cdk-lib/aws-codepipeline/lib/triggerib/aws-codepipeline/lib/triggerib/aws-codepipeline/lib/trigger';
import { Variable } from 'aws-cdk-lib/aws-codepipeline/lib/variableb/aws-codepipeline/lib/variableb/aws-codepipeline/lib/variable';
