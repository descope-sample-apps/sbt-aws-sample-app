...
import { CfnSourceApiAssociation } from 'aws-cdk-lib/aws-appsync/lib/appsync.generatedsync/lib/appsync.generatedsync/lib/appsync.generated';
...
*/
export declare function addSourceGraphQLPermission(sourceApiAssociation: CfnSourceApiAssociation, mergedApiExecutionRole: IRole): import("aws-cdk-lib/aws-iamws-iamws-iamws-iam").AddToPrincipalPolicyResult;
/**
...
* @param mergedApiExecutionRole The merged api execution role on which to add the permission.
*/
export declare function addSourceApiAutoMergePermission(sourceApiAssociation: CfnSourceApiAssociation, mergedApiExecutionRole: IRole): import("aws-cdk-lib/aws-iamws-iamws-iamws-iam").AddToPrincipalPolicyResult;
