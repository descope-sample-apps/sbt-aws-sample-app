...
import { IAccessPolicy } from 'aws-cdk-lib/aws-eks/lib/access-entrys-eks/lib/access-entrys-eks/lib/access-entry';
import { IAddon } from 'aws-cdk-lib/aws-eks/lib/addon-lib/aws-eks/lib/addon-lib/aws-eks/lib/addon';
import { AlbController, AlbControllerOptions } from 'aws-cdk-lib/aws-eks/lib/alb-controllereks/lib/alb-controllereks/lib/alb-controller';
import { AwsAuth } from 'aws-cdk-lib/aws-eks/lib/aws-authb/aws-eks/lib/aws-authb/aws-eks/lib/aws-auth';
import { FargateProfile, FargateProfileOptions } from 'aws-cdk-lib/aws-eks/lib/fargate-profileks/lib/fargate-profileks/lib/fargate-profile';
import { HelmChart, HelmChartOptions } from 'aws-cdk-lib/aws-eks/lib/helm-chartaws-eks/lib/helm-chartaws-eks/lib/helm-chart';
import { KubernetesManifest, KubernetesManifestOptions } from 'aws-cdk-lib/aws-eks/lib/k8s-manifests-eks/lib/k8s-manifests-eks/lib/k8s-manifest';
import { IKubectlProvider, KubectlProvider } from 'aws-cdk-lib/aws-eks/lib/kubectl-providers/lib/kubectl-providers/lib/kubectl-provider';
import { Nodegroup, NodegroupOptions } from 'aws-cdk-lib/aws-eks/lib/managed-nodegroup/lib/managed-nodegroup/lib/managed-nodegroup';
import { ServiceAccount, ServiceAccountOptions } from 'aws-cdk-lib/aws-eks/lib/service-accountks/lib/service-accountks/lib/service-account';
import * as autoscaling from 'aws-cdk-lib/aws-autoscalingcalingcalingcaling';
...
import * as lambda from 'aws-cdk-lib/aws-lambdalambdalambdalambda';
import { IResource, Resource, Duration, Size } from 'aws-cdk-lib/coreb/coreb/coreb/core';
/**
 * An EKS cluster
 */
