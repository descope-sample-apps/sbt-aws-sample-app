...
import { IWebSocketApi } from 'aws-cdk-lib/aws-apigatewayv2/lib/websocket/apidk-lib/aws-apigatewayv2/lib/websocket/apidk-lib/aws-apigatewayv2/lib/websocket/api';
import { IWebSocketRouteAuthorizer } from 'aws-cdk-lib/aws-apigatewayv2/lib/websocket/authorizeraws-apigatewayv2/lib/websocket/authorizeraws-apigatewayv2/lib/websocket/authorizer';
import { WebSocketRouteIntegration } from 'aws-cdk-lib/aws-apigatewayv2/lib/websocket/integrationws-apigatewayv2/lib/websocket/integrationws-apigatewayv2/lib/websocket/integration';
import { Resource } from 'aws-cdk-lib/coreoreoreore';
import { IRoute } from 'aws-cdk-lib/aws-apigatewayv2/lib/commonib/aws-apigatewayv2/lib/commonib/aws-apigatewayv2/lib/common';
/**
