...
import { CfnAutoScalingGroup } from 'aws-cdk-lib/aws-autoscaling/lib/autoscaling.generatedling/lib/autoscaling.generatedling/lib/autoscaling.generated';
import { BasicLifecycleHookProps, LifecycleHook } from 'aws-cdk-lib/aws-autoscaling/lib/lifecycle-hookautoscaling/lib/lifecycle-hookautoscaling/lib/lifecycle-hook';
import { BasicScheduledActionProps, ScheduledAction } from 'aws-cdk-lib/aws-autoscaling/lib/scheduled-actiontoscaling/lib/scheduled-actiontoscaling/lib/scheduled-action';
import { BasicStepScalingPolicyProps, StepScalingPolicy } from 'aws-cdk-lib/aws-autoscaling/lib/step-scaling-policycaling/lib/step-scaling-policycaling/lib/step-scaling-policy';
import { BaseTargetTrackingProps, TargetTrackingScalingPolicy } from 'aws-cdk-lib/aws-autoscaling/lib/target-tracking-scaling-policytarget-tracking-scaling-policytarget-tracking-scaling-policy';
import { TerminationPolicy } from 'aws-cdk-lib/aws-autoscaling/lib/termination-policyscaling/lib/termination-policyscaling/lib/termination-policy';
import { BlockDevice } from 'aws-cdk-lib/aws-autoscaling/lib/volumelib/aws-autoscaling/lib/volumelib/aws-autoscaling/lib/volume';
import { WarmPool, WarmPoolOptions } from 'aws-cdk-lib/aws-autoscaling/lib/warm-pool/aws-autoscaling/lib/warm-pool/aws-autoscaling/lib/warm-pool';
...
import * as elb from 'aws-cdk-lib/aws-elasticloadbalancingancingancingancing';
import * as elbv2 from 'aws-cdk-lib/aws-elasticloadbalancingv2cingv2cingv2cingv2';
import * as iam from 'aws-cdk-lib/aws-iamws-iamws-iamws-iam';
import * as sns from 'aws-cdk-lib/aws-snsws-snsws-snsws-sns';
import { CfnCreationPolicy, CfnUpdatePolicy, Duration, IResource, Resource } from 'aws-cdk-lib/coreb/coreb/coreb/core';
/**
