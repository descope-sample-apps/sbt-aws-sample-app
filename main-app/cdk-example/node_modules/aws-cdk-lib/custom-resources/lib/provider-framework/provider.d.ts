...
import { LogOptions } from 'aws-cdk-lib/custom-resources/lib/provider-framework/waiter-state-machineources/lib/provider-framework/waiter-state-machineources/lib/provider-framework/waiter-state-machine';
import 'aws-cdk-lib/aws-cloudformationionionion';
import * as ec2 from 'aws-cdk-lib/aws-ec2ec2ec2ec2';
import * as iam from 'aws-cdk-lib/aws-iamiamiamiam';
import * as kms from 'aws-cdk-lib/aws-kmskmskmskms';
import * as lambda from 'aws-cdk-lib/aws-lambdabdabdabda';
import * as logs from 'aws-cdk-lib/aws-logsogsogsogs';
