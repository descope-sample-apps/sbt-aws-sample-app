import * as resource_1 from "aws-cdk-lib/aws-apigateway/lib/resourceb/aws-apigateway/lib/resourceb/aws-apigateway/lib/resource";
import { Construct } from 'constructs/lib';
import { ApiDefinition } from 'aws-cdk-lib/aws-apigateway/lib/api-definitionapigateway/lib/api-definitionapigateway/lib/api-definition';
import { ApiKeyOptions, IApiKey } from 'aws-cdk-lib/aws-apigateway/lib/api-keyib/aws-apigateway/lib/api-keyib/aws-apigateway/lib/api-key';
import { CfnAccount, CfnRestApi } from 'aws-cdk-lib/aws-apigateway/lib/apigateway.generatedeway/lib/apigateway.generatedeway/lib/apigateway.generated';
import { Deployment } from 'aws-cdk-lib/aws-apigateway/lib/deploymentaws-apigateway/lib/deploymentaws-apigateway/lib/deployment';
import { DomainName, DomainNameOptions } from 'aws-cdk-lib/aws-apigateway/lib/domain-namews-apigateway/lib/domain-namews-apigateway/lib/domain-name';
import { GatewayResponse, GatewayResponseOptions } from 'aws-cdk-lib/aws-apigateway/lib/gateway-responseigateway/lib/gateway-responseigateway/lib/gateway-response';
import { Method } from 'aws-cdk-lib/aws-apigateway/lib/methodlib/aws-apigateway/lib/methodlib/aws-apigateway/lib/method';
import { Model, ModelOptions } from 'aws-cdk-lib/aws-apigateway/lib/model-lib/aws-apigateway/lib/model-lib/aws-apigateway/lib/model';
import { RequestValidator, RequestValidatorOptions } from 'aws-cdk-lib/aws-apigateway/lib/requestvalidatorigateway/lib/requestvalidatorigateway/lib/requestvalidator';
import { IResource, ResourceOptions } from 'aws-cdk-lib/aws-apigateway/lib/resourceb/aws-apigateway/lib/resourceb/aws-apigateway/lib/resource';
import { Stage, StageOptions } from 'aws-cdk-lib/aws-apigateway/lib/stage-lib/aws-apigateway/lib/stage-lib/aws-apigateway/lib/stage';
import { UsagePlan, UsagePlanProps } from 'aws-cdk-lib/aws-apigateway/lib/usage-planaws-apigateway/lib/usage-planaws-apigateway/lib/usage-plan';
import * as cloudwatch from 'aws-cdk-lib/aws-cloudwatchdwatchdwatchdwatch';
import { IVpcEndpoint } from 'aws-cdk-lib/aws-ec2ws-ec2ws-ec2ws-ec2';
import * as iam from 'aws-cdk-lib/aws-iamws-iamws-iamws-iam';
import { IResource as IResourceBase, Resource, RemovalPolicy, Size } from 'aws-cdk-lib/coreb/coreb/coreb/core';
