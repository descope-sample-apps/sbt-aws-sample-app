...
import { ICustomAttribute, StandardAttributes } from 'aws-cdk-lib/aws-cognito/lib/user-pool-attrcognito/lib/user-pool-attrcognito/lib/user-pool-attr';
import { UserPoolClient, UserPoolClientOptions } from 'aws-cdk-lib/aws-cognito/lib/user-pool-clientgnito/lib/user-pool-clientgnito/lib/user-pool-client';
import { UserPoolDomain, UserPoolDomainOptions } from 'aws-cdk-lib/aws-cognito/lib/user-pool-domaingnito/lib/user-pool-domaingnito/lib/user-pool-domain';
import { UserPoolEmail } from 'aws-cdk-lib/aws-cognito/lib/user-pool-emailognito/lib/user-pool-emailognito/lib/user-pool-email';
import { IUserPoolIdentityProvider } from 'aws-cdk-lib/aws-cognito/lib/user-pool-idp-cognito/lib/user-pool-idp-cognito/lib/user-pool-idp';
import { UserPoolResourceServer, UserPoolResourceServerOptions } from 'aws-cdk-lib/aws-cognito/lib/user-pool-resource-server/user-pool-resource-server/user-pool-resource-server';
import { Grant, IGrantable, IRole } from 'aws-cdk-lib/aws-iamws-iamws-iamws-iam';
import { IKey } from 'aws-cdk-lib/aws-kmsws-kmsws-kmsws-kms';
