...
import { IUserPool } from 'aws-cdk-lib/aws-cognito/lib/user-pool/aws-cognito/lib/user-pool/aws-cognito/lib/user-pool';
import { ClientAttributes } from 'aws-cdk-lib/aws-cognito/lib/user-pool-attrcognito/lib/user-pool-attrcognito/lib/user-pool-attr';
import { IUserPoolResourceServer, ResourceServerScope } from 'aws-cdk-lib/aws-cognito/lib/user-pool-resource-server/user-pool-resource-server/user-pool-resource-server';
import { IResource, Resource, Duration, SecretValue } from 'aws-cdk-lib/coreb/coreb/coreb/core';
/**
