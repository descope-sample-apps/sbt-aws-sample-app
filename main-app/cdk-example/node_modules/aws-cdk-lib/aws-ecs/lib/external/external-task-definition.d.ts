...
import { CommonTaskDefinitionAttributes, CommonTaskDefinitionProps, InferenceAccelerator, ITaskDefinition, NetworkMode, TaskDefinition } from 'aws-cdk-lib/aws-ecs/lib/base/task-definition/base/task-definition/base/task-definition';
/**
