...
import { IResource, Resource } from 'aws-cdk-lib/coreoreoreore';
import { ContainerDefinition, ContainerDefinitionOptions, PortMapping, Protocol } from 'aws-cdk-lib/aws-ecs/lib/container-definition/container-definition/container-definition';
import { FirelensLogRouter, FirelensLogRouterDefinitionOptions } from 'aws-cdk-lib/aws-ecs/lib/firelens-log-routerb/firelens-log-routerb/firelens-log-router';
import { PlacementConstraint } from 'aws-cdk-lib/aws-ecs/lib/placementaws-ecs/lib/placementaws-ecs/lib/placement';
import { ProxyConfiguration } from 'aws-cdk-lib/aws-ecs/lib/proxy-configuration/proxy-configurationn/proxy-configurationn/proxy-configuration';
import { RuntimePlatform } from 'aws-cdk-lib/aws-ecs/lib/runtime-platform/lib/runtime-platform/lib/runtime-platform';
/**
