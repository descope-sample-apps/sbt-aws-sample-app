...
import { ScalableTaskCount } from 'aws-cdk-lib/aws-ecs/lib/base/scalable-task-countib/base/scalable-task-countib/base/scalable-task-count';
import { ServiceManagedVolume } from 'aws-cdk-lib/aws-ecs/lib/base/service-managed-volumebase/service-managed-volumebase/service-managed-volume';
import * as appscaling from 'aws-cdk-lib/aws-applicationautoscalinginginging';
import * as cloudwatch from 'aws-cdk-lib/aws-cloudwatchtchtchtch';
import * as ec2 from 'aws-cdk-lib/aws-ec2ec2ec2ec2';
import * as elb from 'aws-cdk-lib/aws-elasticloadbalancinginginging';
import * as elbv2 from 'aws-cdk-lib/aws-elasticloadbalancingv2gv2gv2gv2';
import * as cloudmap from 'aws-cdk-lib/aws-servicediscoveryeryeryery';
import { Duration, IResource, Resource } from 'aws-cdk-lib/coreoreoreore';
import { LoadBalancerTargetOptions, TaskDefinition, TaskDefinitionRevision } from './task-definition/base/task-definition/base/task-definition/base/task-definition';
import { ICluster, CapacityProviderStrategy } from 'aws-cdk-lib/aws-ecs/lib/clusterb/aws-ecs/lib/clusterb/aws-ecs/lib/cluster';
import { ContainerDefinition, Protocol } from 'aws-cdk-lib/aws-ecs/lib/container-definition/container-definition/container-definition';
import { CfnService } from 'aws-cdk-lib/aws-ecs/lib/ecs.generatedecs/lib/ecs.generatedecs/lib/ecs.generated';
import { LogDriver } from 'aws-cdk-lib/aws-ecs/lib/log-drivers/log-driverog-drivers/log-driverog-drivers/log-driver';
/**
