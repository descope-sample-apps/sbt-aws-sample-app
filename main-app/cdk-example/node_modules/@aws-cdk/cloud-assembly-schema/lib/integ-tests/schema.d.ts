import { TestCase } from '@aws-cdk/cloud-assembly-schema/lib/integ-tests/test-caseoud-assembly-schema/lib/integ-tests/test-caseoud-assembly-schema/lib/integ-tests/test-caseoud-assembly-schema/lib/integ-tests/test-case';
/**
